...
<div class="yjfk-wrapper">
	<h1>意见反馈</h1>	
	<form action="">
		<p>姓名</p><span class="icon icon-name"></span><input type="text" required="required" />
		<p>手机号码</p><span class="icon icon-phone"></span><input type="text" required="required" />
		<p>主题</p><span class="icon icon-theme"></span><input type="text" required="required" />
		<p id="yjfk-content">反馈内容</p><span class="icon icon-contents"></span><textarea></textarea>
