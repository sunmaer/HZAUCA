...
<div class="jsbkContents-wrapper">
	<div class="jsbk-sidebar">
		<p class="jsbk-sidebar-p">计协特色</p>
		<hr />
		<p><a href="#">在线报修</a></p>
		<p><a href="<?php echo U('Index/jnpx');?>">技能培训</a></p>
		<p><a href="<?php echo U('Index/jsbk');?>">技术博客</a></p>
	</div>
	<div class="jsbkContents-right">
		<h1 class="jsbkContents-h1">计算机协会义务维修活动总结</h1>
		<p>作者：孙梦海  发布日期：2016-04-16 15:00</p>
		<div class="jsbkContents-content">
